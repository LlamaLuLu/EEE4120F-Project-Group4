...
module ALU_tb;
    ...
    initial begin
        ...
        check_result(result, 16'd15, test_id); 
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;

        // test 2:
        a = 16'hFFFF; b = 16'h0001; alu_control = 3'b000; #10;
        ...
        check_result(result, 16'hFFFB, test_id);  // wrapped: 65536 - 5
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;
        ...
        // test 7:
        a = 16'h0000; b = 16'd5; alu_control = 3'b010; #10;
        check_result(result, 16'hFFFF, test_id); 
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;

        // test 8:
        a = 16'hFFFF; b = 16'd7; alu_control = 3'b010; #10;
        check_result(result, 16'h0000, test_id); 
        check_zero(zero, 1'b1, test_id);
        test_id = test_id + 1;

        // test 9:
        a = 16'hA5A5; b = 16'd10; alu_control = 3'b010; #10;
        ...
        check_result(result, 16'd16, test_id); 
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;

        // test 11:
        a = 16'h0003; b = 16'd2; alu_control = 3'b011; #10;
        check_result(result, 16'd12, test_id); 
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;
        ...
        check_result(result, 16'd8, test_id); 
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;
        ...
        check_result(result, 16'd0, test_id);  // integer division
        check_zero(zero, 1'b1, test_id);
        test_id = test_id + 1;
        ...
        // test 18:
        a = 16'd0; b = 16'd1; alu_control = 3'b101; #10;
        check_result(result, 16'd0, test_id);  
        check_zero(zero, 1'b1, test_id);
        test_id = test_id + 1;
        ...
        check_result(result, 16'hBEEF, test_id);  
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;
        ...
        check_result(result, 16'd1, test_id); 
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;

        // test 23:
        a = 16'd10; b = 16'd10; alu_control = 3'b111; #10;
        check_result(result, 16'd0, test_id);  // strictly less than
        check_zero(zero, 1'b1, test_id);
        test_id = test_id + 1;
        ...
        check_result(result, 16'd7, test_id); 
        check_zero(zero, 1'b0, test_id);
        test_id = test_id + 1;
