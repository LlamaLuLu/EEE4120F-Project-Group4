...
module DataMemory_tb;
    ...
    initial begin
        ...
        mem_read = 1'b1;
        mem_access_addr = 16'd0; #5;
        if (mem_read_data !== 16'h0001) begin  
            $display("FAIL [T%0d]: addr=0 got=0x%h exp=0x0001", test_id, mem_read_data);
        ...
        if (mem_read_data !== 16'h0002) begin
        ...
        if (mem_read_data !== 16'h0003) begin
        ...
        if (mem_read_data !== 16'h0004) begin
        ...
        if (mem_read_data !== 16'h0005) begin
        ...
        if (mem_read_data !== 16'h0006) begin
        ...
        if (mem_read_data !== 16'h0007) begin
        ...
        if (mem_read_data !== 16'h0008) begin
        ...
        mem_access_addr = 16'd0;
        mem_write_data  = 16'hABCD;
        @(posedge clk); #1;  // wait for rising edge, settle 1ns
        mem_write_en    = 1'b0;
        ...
        mem_write_data  = 16'hBB01;
        @(posedge clk); #1;
        mem_write_en    = 1'b0;

        mem_access_addr = 16'd1; #5;
        if (mem_read_data !== 16'hBB01) begin
            $display("FAIL [T%0d]: addr=1 got=0x%h exp=0xBB01", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        mem_write_data  = 16'hCC02;
        @(posedge clk); #1;
        mem_write_en    = 1'b0;

        mem_access_addr = 16'd2; #5;
        if (mem_read_data !== 16'hCC02) begin
            $display("FAIL [T%0d]: addr=2 got=0x%h exp=0xCC02", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        mem_write_data  = 16'hDD03;
        @(posedge clk); #1;
        mem_write_en    = 1'b0;

        mem_access_addr = 16'd3; #5;
        if (mem_read_data !== 16'hDD03) begin
            $display("FAIL [T%0d]: addr=3 got=0x%h exp=0xDD03", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        mem_write_data  = 16'hEE04;
        @(posedge clk); #1;
        mem_write_en    = 1'b0;

        mem_access_addr = 16'd4; #5;
        if (mem_read_data !== 16'hEE04) begin
            $display("FAIL [T%0d]: addr=4 got=0x%h exp=0xEE04", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        mem_write_data  = 16'hFF05;
        @(posedge clk); #1;
        mem_write_en    = 1'b0;

        mem_access_addr = 16'd5; #5;
        if (mem_read_data !== 16'hFF05) begin
            $display("FAIL [T%0d]: addr=5 got=0x%h exp=0xFF05", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        mem_write_data  = 16'h1106;
        @(posedge clk); #1;
        mem_write_en    = 1'b0;

        mem_access_addr = 16'd6; #5;
        if (mem_read_data !== 16'h1106) begin
            $display("FAIL [T%0d]: addr=6 got=0x%h exp=0x1106", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        mem_write_data  = 16'h2207;
        @(posedge clk); #1;
        mem_write_en    = 1'b0;

        mem_access_addr = 16'd7; #5;
        if (mem_read_data !== 16'h2207) begin
            $display("FAIL [T%0d]: addr=7 got=0x%h exp=0x2207", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        if (mem_read_data !== 16'hBEEF) begin
            $display("FAIL [T%0d]: immediate read got=0x%h exp=0xBEEF", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
        ...
        mem_read = 1'b1; #5;
        if (mem_read_data !== 16'hBB01) begin
            $display("FAIL [T%0d]: write_en=0 but memory changed, got=0x%h exp=0xBB01", test_id, mem_read_data);
            fail_count = fail_count + 1;
        end else
            $display("PASS [T%0d]", test_id);
        test_id = test_id + 1;
